    ...
    return (
        <div className="container">
            ...
            <div className="admin-buttons">
                {administrator && (
                    <button
                        onClick={() => setRaspored({ naziv_rasporeda: "" })}
                    >
                        Dodaj raspored nastave
                    </button>
                )}

                {administrator && (
                    <button onClick={() => setStavka(true)}>
                        Dodaj stavku rasporeda nastave
                    </button>
                )}
            </div>
            ...
            {raspored && (
                <IzmeniRaspored
                    kreirajNovog={
                        administrator && raspored.naziv_rasporeda === ""
                    }
                    raspored={raspored}
                    closeModal={(osvezi) => {
                        setRaspored(null);
            ...
            <div className="container tabela">
                <div className="red header">
                    <div className="naziv">Naziv rasporeda nastave</div>
                    <div className="datum-od">Pocetak</div>
                    <div className="datum-do">Kraj</div>
                    <div></div>
                </div>
